...
void main() {
  ...
  testWidgets('the pit question editor holds up at 200% text', (tester) async {
    ...
    expect(find.text('Drive train'), findsOneWidget);
  });
  ...
  testWidgets('the team lookup view holds up at 200% text', (tester) async {
    ...
    await scouting.saveEntry(
      ScoutEntry(
        ...
        fieldValues: const <String, dynamic>{
          ...
          'eLow': 'Outpost',
          'comments':
              'Fast cycles, dropped one coral in the last twenty seconds',
        },
      ),
    );
    ...
    final noteFinder = find.textContaining('Fast cycles, dropped one coral');
