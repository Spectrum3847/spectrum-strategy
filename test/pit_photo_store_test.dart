...
import 'package:spectrumstrategy/src/scouting/services/pit_photo_capture.dart';
...
void main() {
  ...
  group('validatePhotoPathSegment', () {
    test('accepts a uuid and an entry id', () {
      validatePhotoPathSegment('3f2504e0-4f89-41d3-9a0c-0305e82c3301');
      validatePhotoPathSegment('entry_1');
      validatePhotoPathSegment('Entry-1');
    });

    test('rejects anything that could break out of its key prefix', () {
