...
void main() {
  ...
  testWidgets('centers the table on a wide viewport where it is narrower '
      'than the screen', (tester) async {
    ...
    final tableTopLeft = tester.getTopLeft(find.byType(DataTable));
    expect(tableTopLeft.dx, greaterThan(0));

    expect(tableTopLeft.dy, lessThan(50));
  });

  testWidgets('still scrolls horizontally on a narrow viewport', (
    tester,
  ) async {
    addTearDown(tester.view.reset);
