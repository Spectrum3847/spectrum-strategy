...
void main() {
  ...
  group('TeamCompareStats.fuelSeries', () {
    ...
    test('non-contiguous match numbers pass through unchanged', () {
      final rows = TeamCompareStats.rowsFor(254, [
        _entry(254, tbaMatchKey: '2026txhou_qm1'),
        _entry(254, tbaMatchKey: '2026txhou_qm4'),
      ], config: _config());
      final (_, _, matchNumbers) = TeamCompareStats.fuelSeries(rows);
      expect(matchNumbers, [1, 4]);
    });
  });
}
