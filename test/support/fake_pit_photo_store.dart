...
class FakePitPhotoStore implements PitPhotoStore {
  ...
  Future<String> capture({
    ...
    return _put(
      entryId,
      photoId,
      Uint8List.fromList('fake-jpeg-bytes-for-$photoId'.codeUnits),
    );
  }

  @override
  Future<String> write(String entryId, Uint8List bytes) async =>
      _put(entryId, const Uuid().v4(), bytes);

  String _put(String entryId, String photoId, Uint8List bytes) {
    _store.putIfAbsent(entryId, () => <String, Uint8List>{});
    _store[entryId]![photoId] = bytes;
