...
ScoutConfigField _climbLevel(String code) => ScoutConfigField(
  ...
  retiredChoiceKeys: const {'Outpost', 'Middle', 'Depot'},
);
...
void main() {
  group('TeamSummaryStats.build', () {
    ...
    group('climb success rates', () {
      ...
      test('eLow: Successful or a retired named position both count, Failed '
          'and N/A do not', () {
        final rows = TeamSummaryStats.build(
          [
            _entry(254, match: 'qm1', fieldValues: {'eLow': 'Successful'}),

            _entry(254, match: 'qm2', fieldValues: {'eLow': 'Outpost'}),
            _entry(254, match: 'qm3', fieldValues: {'eLow': 'Middle'}),
            _entry(254, match: 'qm4', fieldValues: {'eLow': 'Depot'}),
