...
String _doc(PrescoutEntry entry, {DateTime? serverTs}) => jsonEncode({
  'name':
      'projects/demo/databases/(default)/documents/prescoutEntries/'
      '${entry.id}',
...
void main() {
  ...
  test(
    ...
    () async {
      final first = PrescoutEntry(
        id: 'p-a',
        teamNumber: 1,
        updatedAt: DateTime.utc(2026, 7, 1),
      );
      final second = PrescoutEntry(
        id: 'p-b',
        teamNumber: 2,
      ...
      final snapshots = <List<PrescoutEntry>>[];
  ...
  test(
    ...
    () async {
      final docA = PrescoutEntry(
        id: 'a',
        teamNumber: 1,
        updatedAt: DateTime.utc(2026, 7, 1),
      );
      final docB = PrescoutEntry(
        id: 'b',
        teamNumber: 2,
