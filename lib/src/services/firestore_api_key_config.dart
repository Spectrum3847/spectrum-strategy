...
class FirestoreApiKeyConfig {
  FirestoreApiKeyConfig({
    this._remoteFetcher,
    Future<SharedPreferences> Function()? prefsLoader,
    this._fallbackKey = const String.fromEnvironment('OPENROUTER_API_KEY'),
    this.prefsKey = openRouterPrefsKey,
    this._field = openRouterField,
  }) : _prefsLoader = prefsLoader ?? SharedPreferences.getInstance;

  factory FirestoreApiKeyConfig.huggingFace({
    ...
    fallbackKey: '',
    prefsKey: huggingFacePrefsKey,
    field: huggingFaceField,
  );

  factory FirestoreApiKeyConfig.match13({
    Future<String?> Function()? remoteFetcher,
    Future<SharedPreferences> Function()? prefsLoader,
  }) => FirestoreApiKeyConfig(
    remoteFetcher: remoteFetcher,
    prefsLoader: prefsLoader,
    fallbackKey: '',
    prefsKey: match13PrefsKey,
    field: match13Field,
  );

  static const String openRouterPrefsKey = 'openrouter_team_api_key';
  static const String huggingFacePrefsKey = 'huggingface_team_api_key';
  static const String openRouterField = 'openrouter';
  static const String huggingFaceField = 'huggingface';
  static const String match13PrefsKey = 'match13_team_api_key';
  static const String match13Field = 'match13';
