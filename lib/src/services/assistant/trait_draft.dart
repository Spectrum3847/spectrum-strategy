...
class TraitDraft {
  ...
  static const String _system =
      ...
      '"not enough data" for that trait rather than guessing. '
  ...
  static String _prompt(
    ...
    if (notes.isEmpty) {
      ...
      buffer
        ..writeln('Scouting comments:')
        ..writeln(wrapUntrustedText(_commentsBlock(notes)));
    }
  ...
  static String _commentsBlock(List<TeamNote> notes) {
    final buffer = StringBuffer();
