...
class TeamCompareSummary {
  ...
  static const String _system =
      ...
      "JSON payload of one team's stats and scouter comments. "
  ...
  static AssistantRequest? request({
    ...
    final payload = <String, dynamic>{
      ...
      'redOrYellowCards': _countCarded(teamEntries),
    ...
    return AssistantRequest(
      ...
      system: _system,
      prompt: '$prompt\n\n${wrapUntrustedText(jsonEncode(payload))}',
  ...
  static int _countCarded(List<ScoutEntry> entries) {
    var count = 0;
    for (final entry in entries) {
      if (ScoutingMeetingStats.cardColorOf(entry.fieldValues[_cardCode]) !=
          null) {
        count++;
      }
    }
