...
import '../scouting/models/pit_shift_mirror.dart';
...
import '../scouting/services/pit_shift_mirror_sync_service.dart';
...
class LocalOnlyPitShiftMirrorSyncService implements PitShiftMirrorSyncService {
  @override
  Stream<PitShiftMirror?> get mirrorStream =>
      Stream<PitShiftMirror?>.value(null);
