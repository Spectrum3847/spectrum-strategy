...
class StrategyApp extends StatefulWidget {
  const StrategyApp({
    ...
    required this.pitShiftMirrorController,
...
class _StrategyAppState extends State<StrategyApp> {
  ...
  void dispose() {
    ...
    widget.pitShiftMirrorController.dispose();
      ...
      home: FutureBuilder<void>(
        ...
        builder: (context, snapshot) {
          ...
          return AppShell(
            ...
            pitShiftMirrorController: widget.pitShiftMirrorController,
            ...
            assistantChatController: widget.assistantChatController,
