        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 4),
              Text(
                'Beta. Draws the app bar, the tab bar, and menus on Apple\'s '
                'Liquid Glass material (iOS 26, iPadOS 26, macOS 26), with '
                'the content behind them showing through. Off by default '
