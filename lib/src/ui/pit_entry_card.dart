...
class _PitEntryCardState extends State<PitEntryCard> {
  static const double _thumbnailSize = 128;
  ...
  void _showFullPhoto(String photoId) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => _PitPhotoViewer(bytes: _bytesFor(photoId)),
      ),
    );
  }
...
class _PitPhotoViewer extends StatelessWidget {
  const _PitPhotoViewer({required this.bytes});
