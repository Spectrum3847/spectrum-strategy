...
class _AllianceGrid extends StatelessWidget {
  const _AllianceGrid({
    required this.board,
    required this.onCellChanged,
    this.cardedTeamNumbers = const <int>{},
  });

  final PlayoffBoard board;
  final void Function(int row, int column, String value) onCellChanged;

  final Set<int> cardedTeamNumbers;
  ...
  Color? _cardColorFor(BuildContext context, String cellValue) {
    ...
    if (team == null || !cardedTeamNumbers.contains(team)) return null;
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        ...
        final cardedTeamNumbers = ScoutingMeetingStats.cardedTeams(
          scoutingController.entries,
        ).toSet();
        ...
        final grid = _AllianceGrid(
          ...
          cardedTeamNumbers: cardedTeamNumbers,
        );
        ...
        Widget teamDetailPanel(int team) => _TeamDetailPanel(
          ...
          assistant: assistant,
          canPublishSummaries: canPublishSummaries,
          carded: cardedTeamNumbers.contains(team),
        );
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            decoration: carded
                ? BoxDecoration(
                    color: StrategyPalette.flagSevereOf(context),
                    borderRadius: const BorderRadius.all(
                      Radius.circular(StrategyPalette.radiusSm),
                    ),
                  )
