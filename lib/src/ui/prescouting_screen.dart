...
import '../scouting/services/prescouting_sync_service.dart';
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        _bullet(
          context,
          'Starting position: Center Hub, Depot Bump, Depot Trench, '
...
class _DataTabState extends State<_DataTab> {
  ...
  bool _canModify(PrescoutEntry entry) =>
      widget.canEditAnyEntry || _isOwn(entry);
        ...
        return Column(
          ...
          children: [
            Padding(
              ...
              child: _SyncStatusChip(status: _controller.syncStatus),
            ),
            Padding(
...
class _SyncStatusChip extends StatelessWidget {
  ...
  final PrescoutingSyncStatus status;

  @override
  Widget build(BuildContext context) {
    final (String label, IconData icon) = switch (status.state) {
      PrescoutingSyncState.signedOut => (
        'Not signed in to sync',
        Icons.cloud_off_rounded,
      ),
      PrescoutingSyncState.noAccess => (
        'No team access yet',
...
class _TeamRecordTable extends StatelessWidget {
  ...
  final bool Function(PrescoutEntry entry) canModify;
                  ...
                  cells: <DataCell>[
                    DataCell(
                      canModify(entry)
                          ...
                          : const Tooltip(
                              message:
                                  'Only the author or a strategy lead can '
                                  'change this record',
