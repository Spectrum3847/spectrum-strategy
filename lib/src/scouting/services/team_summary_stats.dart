...
typedef TeamSummaryValueGetter = double? Function(TeamSummaryRow row);

class TeamSummaryColumn {
  const TeamSummaryColumn(this.label, this.getter, {this.isRate = false});

  final String label;
  final TeamSummaryValueGetter getter;
  final bool isRate;
}

const List<TeamSummaryColumn> teamSummaryColumns = <TeamSummaryColumn>[
  TeamSummaryColumn('IQM Teleop', _iqmTeleop),
  TeamSummaryColumn('Max Teleop', _maxTeleop),
  TeamSummaryColumn('IQM Auto', _iqmAuto),
  TeamSummaryColumn('Max Auto', _maxAuto),
  TeamSummaryColumn('Auto Climb', _autoClimbRate, isRate: true),
  TeamSummaryColumn('Low Climb', _lowClimbRate, isRate: true),
  TeamSummaryColumn('Mid Climb', _middleClimbRate, isRate: true),
  TeamSummaryColumn('High Climb', _highClimbRate, isRate: true),
];
