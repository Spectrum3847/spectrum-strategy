...
through installing everything from scratch on Windows, macOS, and Linux, and a
recommended git GUI client.
...
- No local Flutter install? Install the version named above and run the three
  commands directly.
