...
test('a hanging fetch aborts after the request timeout instead of hanging the run', async () => {
  ...
  try {
    ...
    const pending = getDocument('proj', 'appConfig/activeEvent', { token: 't', fetchImpl });
